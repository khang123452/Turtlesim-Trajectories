...
class PathPlanner(Node):
    def __init__(self):
        ...
        # Declare a parameter for trajectory, default to 'circle'
        self.declare_parameter('trajectory', 'star')
    ...
    def star_trajectory(self, msg):
        ...
        segment_duration = 1.0  # Time to draw one segment of the star
        turn_duration = 1.0  # Time to turn the required angle for the star
        ...
        if time_elapsed < total_star_duration:
            ...
            if phase_time < segment_duration:
                ...
                msg.linear.x = 0.0
                msg.angular.z = (1.2 * math.pi)  # Sharp turn to make the star points
        else:
            msg.linear.x = 0.0
            msg.angular.z = 0.0 
